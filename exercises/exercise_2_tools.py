...
def check_statute_of_limitations(case_type: str) -> str:
    ...
    Args:
        case_type: Loại vụ án (hợp đồng/contract, dân sự/tort, lao động/labor)
    """
    limits = {
        "hợp đồng": "2 năm (Bộ luật Dân sự 2015)",
        "contract": "4 năm (UCC § 2-725)",
        "dân sự": "3 năm",
        "tort": "2-3 năm tùy bang",
        "lao động": "1 năm",
        "labor": "180 ngày hoặc 1 năm tùy trường hợp",
    }
    case_type_lower = case_type.lower()
    for key, value in limits.items():
        if key in case_type_lower:
            return f"Thời hiệu khởi kiện cho {key} là {value}."
    return "Không xác định được thời hiệu khởi kiện cho loại vụ án này."
